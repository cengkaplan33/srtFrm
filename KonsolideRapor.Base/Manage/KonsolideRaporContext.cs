...
namespace KonsolideRapor.Base.Manage
{
    public class KonsolideRaporContext
    {
        #region Constructor

        public KonsolideRaporContext(IKonsolideRaporApplicationManager konsolideRaporApplicationManager)
        {
