...
namespace Surat.Document.Base.Configuration
{
    public class DocumentConfigurationContext
    {
        #region Constructor

        public DocumentConfigurationContext(IDocumentApplicationManager documentApplicationManager)
        {
