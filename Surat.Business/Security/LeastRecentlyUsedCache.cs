...
{
    public class LeastRecentlyUsedCache<T> where T: LeastRecentlyUsedCacheNode
    {
        ...
        private void InitHead(LeastRecentlyUsedCacheNode item)
        {
            _count = 1;
            item._next = item;
            item._prev = item;
        ...
        public void Remove(LeastRecentlyUsedCacheNode item)
        {
            if (item._next == item)
            {
                _head = null;
