...
namespace KonsolideRapor.WebServer.Controllers
{
    public class RolesController : KonsolideControllerBase
    {
        ...
        [ActionAttribute("Rolleri Kullanıcıya GöreGetir", "Sistemde kayıtlı olan rolleri kullanıcıya göre getirir.", Surat.Common.Data.Constants.Application.WebFrameworkSystemName, ActionType.Action)]
