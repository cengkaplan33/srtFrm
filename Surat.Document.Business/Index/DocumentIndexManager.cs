...
namespace Surat.Document.Business.Index
{
    public class DocumentIndexManager
    {
        #region Constructor

        public DocumentIndexManager(IDocumentApplicationManager documentApplicationManager)
        {
        ...
        public DocumentIndexContext Context
        {
            get
            {
                return applicationContext.Index;
            }
        }
